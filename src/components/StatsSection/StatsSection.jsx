  ...
  return (
    <div className="w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] py-10 md:py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-wrap md:flex-nowrap items-center justify-around gap-4 text-center text-white md:flex-row md:gap-0">
          ...
          <div className="hidden md:block border-l-2 border-white/50 h-16"></div>
